            ...
            cart.length > 0 ? 
                (<div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
                    <div className="w-[100%] md:w-[60%] flex flex-col p-2">
                        {
                            cart.map( (item,index) => (<CartItem item={item} key={item.id} itemIndex={index} isLast={index === cart.length-1} />))
                    ...
                    <div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
                        <div className="flex flex-col p-5 gap-5 my-14  h-[100%] justify-between">
                            <div className="flex flex-col gap-5 ">
                                <div className="font-bold text-xl text-green-800 uppercase">Your Cart</div>

                                <div className="font-bold text-5xl text-green-700 -mt-5 uppercase">Summary</div>
                                <p className="text-xl">
                                    <span className="text-gray-700 font-semibold text-2xl">Total Items: {cart.length}</span>
                                </p>
                            </div>
                        </div>
